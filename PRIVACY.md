...
nearby compatibility files. It writes the reviewed wrapper plan, backup and
manifest only in the selected game directory. A support package is created only
